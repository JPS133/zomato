...
import { Clock, MapPin, Info, IndianRupee, Plus, Minus } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 dark:bg-gray-900">
      ...
      <div className="mt-12">
        ...
        {Object.keys(menu).length === 0 ? (
          <p className="text-gray-500 text-lg py-10">No food items added for this restaurant yet. Add some in the Admin Panel!</p>
        ) : (
                            ...
                            {quantity === 0 ? (
                              <button 
                                onClick={() => addItem({
                                  ...
                                  veg: false
                                }, restaurant.id.toString(), restaurant.name)}
